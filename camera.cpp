...
LONG CCameraModule::Unlock()
{
	AfxOleUnlockApp();
	return 0;
}

LONG CCameraModule::Lock()
{
	AfxOleLockApp();
	return 1;
}
LPCTSTR CCameraModule::FindOneOf(LPCTSTR p1, LPCTSTR p2)
{
	while (*p1 != NULL)
	{
		LPCTSTR p = p2;
...
BOOL CCameraApp::InitATL()
{
	...
	while (lpszToken != NULL)
	{
		...
		{
			_Module.UpdateRegistryFromResource(IDR_CAMERA, FALSE);
		...
		{
			_Module.UpdateRegistryFromResource(IDR_CAMERA, TRUE);
